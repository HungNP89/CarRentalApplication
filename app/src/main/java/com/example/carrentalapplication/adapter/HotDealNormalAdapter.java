...
public class HotDealNormalAdapter extends RecyclerView.Adapter<HotDealNormalAdapter.ViewHolder> {
    Context context;
    List<HotDealNormalModel> list;

    public HotDealNormalAdapter(Context context, List<HotDealNormalModel> list) {
    ...
    @NonNull
    @Override
    public HotDealNormalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new HotDealNormalAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_popular_normal, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull HotDealNormalAdapter.ViewHolder holder, int position) {
